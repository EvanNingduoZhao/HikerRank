    ...
    try:
        ...
        with urllib.request.urlopen(url) as url:
            ...
            for trail in data['trails']:
                ...
                trail = (str(trail['id']), trail['name'], trail['summary'], trail['difficulty'], trail['location'],
                         trail['longitude'], trail['latitude'], trail['length'], trail['ascent'], trail['descent'],
                         trail['high'], trail['low'], trail['stars'])
    ...
    for index, url in enumerate(url_list):
        ...
        if index <= 3:
            ...
            browser.find_element_by_xpath(
                "//*[@id=\"login-modal\"]/div/div/div[2]/div/div[2]/form[2]/div[1]/input").send_keys(
                'yuchenxi@andrew.cmu.edu')
            browser.find_element_by_xpath(
                "//*[@id=\"login-modal\"]/div/div/div[2]/div/div[2]/form[2]/div[2]/input").send_keys("Xyc687097")
